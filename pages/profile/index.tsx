...
import CollaboratorProfile from "../../components/profiles/collaborator";
import GuestProfile from "../../components/profiles/guest";
...
const Profile = (props: Props) => {
  ...
  return (
    <>
      ...
      {session === "Collaborator" ? <CollaboratorProfile /> : <GuestProfile />}
