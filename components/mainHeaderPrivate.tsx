...
const mainHeader = () => {
  ...
  const handleResourcePage = () => {
    Router.push("/resources");
  };

  const handleOpportunitiesPage = () => {
  ...
  const handleSchoolProfilePage = () => {
    Router.push("/school");
  };
  const handleChapterProfilePage = () => {
    Router.push("/chapter");
  };
        ...
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto">
          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                  ...
                  <Menu.Items className="absolute right-0 w-56 mt-2 origin-top-right bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="px-1 py-1 ">
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <button
                            onClick={handleChapterProfilePage}
                            className={`${
                              active
                                ? "bg-violet-500 text-white"
                                : "text-gray-900"
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <button
                            onClick={handleSchoolProfilePage}
                            className={`${
                              active
                                ? "bg-violet-500 text-white"
                                : "text-gray-900"
              ...
              <li>
                <button
                  onClick={handleOpportunitiesPage}
                  className="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700"
                >
                  Opportunities
                </button>
